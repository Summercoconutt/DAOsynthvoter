...
def main() -> None:
    ...
    _, valid_raw = split_by_voter(raw_df, train_frac=0.8, seed=args.seed)
    preprocessor = cfg.get("numeric_preprocessor")
    if preprocessor is None:
        raise RuntimeError("Missing numeric_preprocessor in config.json; please retrain model with updated training script.")
